...
if (isset($_POST['submit'])) { // if form has been submitted
	...
	$check = mysqli_query($conn,"SELECT * FROM users WHERE username = '". $_POST['username']."'")or die(mysqli_error());
	...
	<table border="0"> 
	<p>This page is for member only</p>
	...
	<br>
	<br>
	<p>No account?<a href="db-login.php"> Create one</a></p>
	</td></tr> 
	</table> 
	</form> 
	<br>
